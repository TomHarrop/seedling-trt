...
# bamfile_list <- c("output/star_pass2/mmno/mmno_p1.Aligned.sortedByCoord.out.bam", 
#                   "output/star_pass2/mmno/mmno_p2.Aligned.sortedByCoord.out.bam", 
#                   "output/star_pass2/mmno/mmnoheat_p1.Aligned.sortedByCoord.out.bam", 
#                   "output/star_pass2/mmno/mmnoheat_p2.Aligned.sortedByCoord.out.bam", 
#                   "output/star_pass2/mmno/untreated_p1.Aligned.sortedByCoord.out.bam", 
#                   "output/star_pass2/mmno/untreated_p2.Aligned.sortedByCoord.out.bam")
